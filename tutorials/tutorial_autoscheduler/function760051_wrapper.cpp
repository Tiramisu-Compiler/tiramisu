...
int main(int, char **argv)
{
	...
	parallel_init_buffer(c_buf00, 256*256, (double)72);
	Halide::Buffer<double> buf00(c_buf00, 256,256);

	double *c_buf01 = (double*)malloc(256*256*256* sizeof(double));
	parallel_init_buffer(c_buf01, 256*256*256, (double)58);
	Halide::Buffer<double> buf01(c_buf01, 256,256,256);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function760051(buf00.raw_buffer(),buf01.raw_buffer());
