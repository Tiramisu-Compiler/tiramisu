#ifndef HALIDE__function_cholesky_LARGE_o_h
#define HALIDE__function_cholesky_LARGE_o_h
#include <stdint.h>
...
int function_cholesky_LARGE(struct halide_buffer_t *_b_A_buffer) HALIDE_FUNCTION_ATTRS;
int function_cholesky_LARGE_old_buffer_t(struct buffer_t *_b_A) HALIDE_FUNCTION_ATTRS;
