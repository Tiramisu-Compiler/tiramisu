#ifndef HALIDE__build___new_o_h
#define HALIDE__build___new_o_h
#include <stdint.h>
...
int function_0(struct halide_buffer_t *_b_output_buffer) HALIDE_FUNCTION_ATTRS;
int function_0_old_buffer_t(struct buffer_t *_b_output) HALIDE_FUNCTION_ATTRS;
