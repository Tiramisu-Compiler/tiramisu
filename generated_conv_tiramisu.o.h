#ifndef HALIDE__generated_conv_tiramisu_o_h
#define HALIDE__generated_conv_tiramisu_o_h
#include <stdint.h>
...
int conv_tiramisu(struct halide_buffer_t *_parameters_buf_buffer, struct halide_buffer_t *_input_buf_buffer, struct halide_buffer_t *_filter_buf_buffer, struct halide_buffer_t *_bias_buf_buffer, struct halide_buffer_t *_conv_buf_buffer) HALIDE_FUNCTION_ATTRS;
int conv_tiramisu_old_buffer_t(struct buffer_t *_parameters_buf, struct buffer_t *_input_buf, struct buffer_t *_filter_buf, struct buffer_t *_bias_buf, struct buffer_t *_conv_buf) HALIDE_FUNCTION_ATTRS;
