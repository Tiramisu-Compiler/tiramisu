...
int main(int, char**)
{
    ...
    init_2D_buffer_val(&reference_buf, NN, MM, 12);
    ...
    test_floor_operator(halide_output_buf.raw_buffer());

    compare_2_2D_arrays("test_floor_operator", halide_output_buf.data(), reference_buf.host, NN, MM);
