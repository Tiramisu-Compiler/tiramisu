...
int main(int, char**)
{
    ...
    assign_7_to_10x10_2D_array_with_auto_unrolling(halide_output_buf.raw_buffer());

    compare_2_2D_arrays("assign_7_to_10x10_2D_array_with_auto_unrolling", halide_output_buf.data(), reference_buf.host, NN, MM);
