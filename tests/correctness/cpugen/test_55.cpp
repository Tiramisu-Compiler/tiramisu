...
void generate_function(std::string name, int size, int val0)
{
    ...
    tiramisu::var i("i");
    tiramisu::var j("j");
    tiramisu::computation S0("[N]->{S0[i,j]: 0<=i<N and 0<=j<N}", tiramisu::expr(tiramisu::o_lerp, (uint8_t) 0, (uint8_t) 1, (uint8_t) 5), true, p_uint8, &function0);
