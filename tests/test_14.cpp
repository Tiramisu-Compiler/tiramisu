...
int main(int argc, char **argv)
{
    ...
    bx.apply_transformation("[Nc, Ny, Nx]->{bx[0, 0, c, 0, y, 0, x, 0]->bx[0, 0, c, 0, floor(y/32), 0, floor(x/32), 0, (y%32), 0, (x%32), 0]}", 0);
    //  shift the duplicate here
    bx.apply_transformation("[Nc, Ny, Nx]->{bx[1, 0, c, 0, y, 0, x, 0]->bx[1, 0, c, 0, y-2, 0, x, 0]}", 1);
