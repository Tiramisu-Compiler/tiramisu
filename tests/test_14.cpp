...
int main(int argc, char **argv)
{
    ...
    tiramisu::computation blur_x_s0("[bx_s0_c_ext, bx_s0_y_ext, bx_s0_x_ext]->{blur_x_s0[blur_x_s0_c, blur_x_s0_y, blur_x_s0_x]: "
                        "(0 <= blur_x_s0_c <= ((0 + bx_s0_c_ext) + -1)) and (0 <= blur_x_s0_y <= ((0 + bx_s0_y_ext) + -1)) and (0 <= blur_x_s0_x <= ((0 + bx_s0_x_ext) + -1))}",
    ...
    tiramisu::computation blur_y_s0("[by_s0_c_ext, by_s0_y_ext, by_s0_x_ext]->{blur_y_s0[blur_y_s0_c, blur_y_s0_y, blur_y_s0_x]: "
                        "(0 <= blur_y_s0_c <= ((0 + by_s0_c_ext) + -1)) and (0 <= blur_y_s0_y <= ((0 + by_s0_y_ext) + -1)) and (0 <= blur_y_s0_x <= ((0 + by_s0_x_ext) + -1))}",
