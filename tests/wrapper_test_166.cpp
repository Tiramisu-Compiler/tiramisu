               ...
               bool transposeA, bool transposeB)
{
    ...
    Halide::Buffer<double> params(2);
    Halide::Buffer<bool> transposes(2);
    Halide::Buffer<double> A(colsA, rowsA);
    Halide::Buffer<double> B(colsB, rowsB);
    Halide::Buffer<double> C(colsC, rowsC);
    Halide::Buffer<double> C_ref(colsC, rowsC);
    sizes(0) = M;
    sizes(1) = N;
    sizes(2) = K;
    sizes(3) = rowsA;
    ...
    test_166(sizes.raw_buffer(), params.raw_buffer(), transposes.raw_buffer(),
