...
void generate_function_1(std::string name, int size, int val0, int val1)
{
    ...
    coli::expr e1 = coli::expr((uint8_t) val0) >> coli::expr((uint8_t) val1);
    ...
    function0.gen_halide_obj("build/generated_fct_test_06.o");
}


int main(int argc, char **argv)
{
    generate_function_1("test_shift_operator", 10, 37, 3);
