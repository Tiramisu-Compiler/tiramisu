#include "Halide.h"
#include "function1024_no_schedule_wrapper.h"
...
int main(int, char **){
    ...
    function1024_no_schedule(buf00.raw_buffer(), buf0.raw_buffer());

    for (int j = 0; j < 25; ++j){
        function1024_no_schedule(buf0.raw_buffer(), buf00.raw_buffer());
        function1024_no_schedule(buf00.raw_buffer(), buf0.raw_buffer());
    }
    ...
    exec_times_file.open("../data/programs/function1024/function1024_no_schedule/exec_times.txt", std::ios_base::app);
    ...
    try {
        imwrite("../data/programs/function1024/function1024_no_schedule/modified.jpeg", img, compression_params);
    }
