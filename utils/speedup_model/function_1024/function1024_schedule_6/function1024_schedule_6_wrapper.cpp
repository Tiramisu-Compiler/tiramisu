#include "Halide.h"
#include "function1024_schedule_6_wrapper.h"
...
int main(int, char **){
    ...
    function1024_schedule_6(buf00.raw_buffer(), buf0.raw_buffer());
    ...
    exec_times_file.open("../data/programs/function1024/function1024_schedule_6/exec_times.txt", std::ios_base::app);
    ...
    try {
        imwrite("../data/programs/function1024/function1024_schedule_6/modified.jpeg", img, compression_params);
    }
