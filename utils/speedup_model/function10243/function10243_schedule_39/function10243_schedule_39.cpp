...
int main(int argc, char **argv){
    tiramisu::init("function10243_schedule_39");
    ...
    tiramisu::codegen({&image_buff, &filter_buff, &convolved_buff}, "../data/programs/function10243/function10243_schedule_39/function10243_schedule_39.o");
