...
#build/test_07
BENCH_REF_GEN=build/bench_halide_cvtcolor_generator build/bench_halide_filter2D_generator build/bench_halide_blurxy_generator build/bench_halide_recfilter_generator build/bench_halide_gaussian_generator build/bench_halide_fusion_generator build/bench_halide_recfilter_generator build/bench_halide_heat2d_generator build/bench_halide_divergence2d_generator
...
BENCH_BIN=build/bench_cvtcolor build/bench_filter2D build/bench_blurxy build/bench_recfilter build/bench_fusion build/bench_gaussian build/bench_heat2d build/bench_divergence2d
