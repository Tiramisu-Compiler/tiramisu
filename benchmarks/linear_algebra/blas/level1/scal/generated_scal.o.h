#ifndef HALIDE__generated_scal_o_h
#define HALIDE__generated_scal_o_h
#include <stdint.h>
...
int scal(struct halide_buffer_t *_b_SIZES_buffer, struct halide_buffer_t *_b_alpha_buffer, struct halide_buffer_t *_b_X_buffer) HALIDE_FUNCTION_ATTRS;
int scal_old_buffer_t(struct buffer_t *_b_SIZES, struct buffer_t *_b_alpha, struct buffer_t *_b_X) HALIDE_FUNCTION_ATTRS;
