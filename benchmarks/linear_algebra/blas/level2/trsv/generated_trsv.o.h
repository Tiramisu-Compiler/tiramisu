#ifndef HALIDE__generated_trsv_o_h
#define HALIDE__generated_trsv_o_h
#include <stdint.h>
...
int trsv(struct halide_buffer_t *_b_SIZES_buffer, struct halide_buffer_t *_b_A_buffer, struct halide_buffer_t *_b_b_buffer, struct halide_buffer_t *_b_X_buffer) HALIDE_FUNCTION_ATTRS;
int trsv_old_buffer_t(struct buffer_t *_b_SIZES, struct buffer_t *_b_A, struct buffer_t *_b_b, struct buffer_t *_b_X) HALIDE_FUNCTION_ATTRS;
