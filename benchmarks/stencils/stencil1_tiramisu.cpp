...
void generate_coli_obj_file()
{
    ...
    //c_b0.set_schedule("{c_b0[i]->[0, i0, 0, i1, 0, b, 0]: i0=floor(i/4) and i1=i%4 and -1<=b<=1}");
    c_b0.set_schedule("{c_b0[i]->c_b0[0, i0, 1, i1, 0, 0, 0]: i0=floor(i/4) and i1=i%4; c_b0[i]->c_b0[0, i0, 0, 0, 0, 0, 0]: i0=floor(i/4)and i%4=-1;c_b0[i]->c_b0[0, i0, 2, 0, 0, 0, 0]: i0=floor(i/4) and i%4=1}");
    c_b1.set_schedule("{c_b1[i]->c_b1[0, i0, 3, i1, 1, 0, 0]: i0=floor(i/4) and i1=i%4}");
    // c_b0.tag_parallel_dimension(0);
