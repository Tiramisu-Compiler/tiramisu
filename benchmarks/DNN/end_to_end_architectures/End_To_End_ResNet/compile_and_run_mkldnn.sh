...
g++ -std=c++11 -I${MKLDNNROOT}/include -L${MKLDNNROOT}/lib end_to_end_resnet_wrapper.cpp -o end_to_end_resnet_mkldnn -Wl,--no-as-needed -lmkl_intel_ilp64 -lmkl_gnu_thread -lmkl_core -lgomp -lpthread -fopenmp -lm -ldl -lmkldnn
./end_to_end_resnet_mkldnn
