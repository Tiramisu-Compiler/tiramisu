...
gcc -DMKL_ILP64 -m64 ${INCLUDES} vgg_block_generator_mkl.c -o vgg_block_mkl ${LIBRARIES_DIR} -Wl,--no-as-needed -lmkl_intel_ilp64 -lmkl_gnu_thread -lmkl_core -lgomp -lpthread -lm -ldl
./vgg_block_mkl