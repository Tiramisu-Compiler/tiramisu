		...
		for Y_BL1 in 2 7; do
			for Y_BL2 in 2 7; do
				for FOUT_BL in 2 4 8 16 32 64; do
					...
					cd ../../../../../../build/benchmarks/DNN/blocks/vggBlock/cpu/sparse_32channels_512_512_28
					make  > /dev/null 2>&1;
					cd ../../../../../../../benchmarks/DNN/blocks/vggBlock/cpu/sparse_32channels_512_512_28;
					execution_output=$(./sparse_vgg_block_wrapper_512_512_28);
