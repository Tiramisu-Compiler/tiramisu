		...
		for Y_BL1 in 2 7; do
			for Y_BL2 in 2 7; do
				for FOUT_BL in 2 4 8 16 32 64; do
					...
					cd ../../../../../../build/benchmarks/DNN/blocks/Conv-ReLU-Conv-ReLU/cpu/sparse_32channels
					make  > /dev/null 2>&1;
					cd ../../../../../../../benchmarks/DNN/blocks/Conv-ReLU-Conv-ReLU/cpu/sparse_32channels;
					execution_output=$(./wrapper_sparse_conv_relu_conv_relu);
