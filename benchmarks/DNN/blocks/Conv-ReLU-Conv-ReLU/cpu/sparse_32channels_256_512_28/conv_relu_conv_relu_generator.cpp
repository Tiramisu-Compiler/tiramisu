...
int main(int argc, char **argv)
{
    ...
    function sparse_conv_relu_conv_relu("sparse_conv_relu_conv_relu_256_512_28_tiramisu");
    ...
    sparse_conv_relu_conv_relu.gen_halide_obj("generated_sparse_conv_relu_conv_relu_256_512_28_tiramisu.o");
