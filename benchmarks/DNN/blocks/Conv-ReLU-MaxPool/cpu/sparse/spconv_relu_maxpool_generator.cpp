...
int main(int argc, char **argv)
{
  ...
  constant maxpool_height("maxpool_height", N / 2, p_int32, true, NULL, 0, &spconv_relu_maxpool);
  constant maxpool_width("maxpool_width", N / 2, p_int32, true, NULL, 0, &spconv_relu_maxpool);
  ...
  maxpool_access << "{maxpool[b,fout,y_b,x_b,yy,xx]->b_result[b,fout,(y_b*"<<Y_BL<<"+yy)/2,(x_b * "<<X_BL<<" + xx)/2]}";
