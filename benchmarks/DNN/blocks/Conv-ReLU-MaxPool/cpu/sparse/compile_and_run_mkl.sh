...
gcc -g -DMKL_ILP64 -m64 ${INCLUDES} conv_relu_maxpool_generator_mkl.c -o conv_relu_maxpool_mkl ${LIBRARIES_DIR} -Wl,--no-as-needed -lmkl_intel_ilp64 -lmkl_gnu_thread -lmkl_core -lgomp -lpthread -lm -ldl
