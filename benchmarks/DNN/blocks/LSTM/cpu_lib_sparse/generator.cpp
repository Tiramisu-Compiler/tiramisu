...
int main(int argc, char **argv)
{
    ...
    input weights("weights", {l, w_i}, DATA_TYPE_P);
    input weights_descr("weights_descr", {l, w_i}, DATA_TYPE_P);
    ...
    computation sum1("sum1", {l, s},
        spmv(
            false,
            1.0,
            *weights.get_buffer(),
            *weights_descr.get_buffer(),
            l,
            0,
            *h.get_buffer(),
            0,
    ...
    computation dummy_c({}, weights(0, 0) + weights_descr(0, 0));
