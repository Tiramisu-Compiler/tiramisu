...
#define K 3
#define STRIDE 2
#define STRIDE2_INPUT_TRANSFORMATION 0

#define WEIGHTS_DENSITY 0.1567
#define WEIGHTS_DENSITY2 0.1297

#define NB_TESTS 101

// Parameters to tune
#define X_BL 14 // Must be a multiple of N
#define X_NB_BL (N/STRIDE/X_BL)

#define Y_BL 2 // Must be a multiple of N
#define Y_NB_BL (N/STRIDE/Y_BL)

#define X_BL2 14 // Must be a multiple of N
