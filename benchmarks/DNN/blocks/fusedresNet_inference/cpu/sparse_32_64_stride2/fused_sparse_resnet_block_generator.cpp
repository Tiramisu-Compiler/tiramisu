...
int main(int argc, char **argv)
{
  ...
  function fused_sparse_resnet_block("fused_sparse_resnet_block_32_64_stride2");
  ...
  fused_sparse_resnet_block.gen_halide_obj("generated_fused_sparse_resnet_block_32_64_stride2.o");
