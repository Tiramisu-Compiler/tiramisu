...
mean1 = np.random.rand(1, FOUT, 1, 1)
variance1 = np.random.rand(1, FOUT, 1, 1)
offset1 = np.random.rand(1, FOUT, 1, 1)
scale1 = np.random.rand(1, FOUT, 1, 1)

mean2 = np.random.rand(1, FOUT, 1, 1)
variance2 = np.random.rand(1, FOUT, 1, 1)
offset2 = np.random.rand(1, FOUT, 1, 1)
scale2 = np.random.rand(1, FOUT, 1, 1)
