...
g++ -O3 -DMKL_ILP64 -m64 ${INCLUDES} sparse_resnet_inference_generator_mkl_sparse.cpp -o resnet_inference_mkl_sparse ${LIBRARIES_DIR} -Wl,--no-as-needed -lmkl_intel_ilp64 -lmkl_gnu_thread -lmkl_core -lgomp -lpthread -fopenmp -lm -ldl  -lmkldnn
