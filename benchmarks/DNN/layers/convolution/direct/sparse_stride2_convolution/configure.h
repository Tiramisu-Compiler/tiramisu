...
#define FIn 32
#define FIN_BL 4 // Used only when IMPORT_CSR_FROM_FILE is at 0, otherwise, the blocked traversal is generated via the python script that exports the layer in CSR format
...
// Parameters to tune
#define X_BL 56
#define X_NB_BL (N/2/X_BL)

#define Y_BL 2
#define Y_NB_BL (N/2/Y_BL)
