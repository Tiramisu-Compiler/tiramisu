...
//     var i("i", 0, 20), j("j", 0, 30), k("k", 0, 20);
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A, &b_B}, "function_trmm_MINI.o", "./function_trmm_MINI_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_trmm_MINI_explored_schedules.json", true);
	}else{
