...
{
    tiramisu::init("function_floyd_warshall_MINI");
    ...
    //Iteration variables    
    var i("i", 0, 60), j("j", 0, 60), k("k", 0, 60);
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer b_paths("b_paths", {60,60}, p_float64, a_output);    
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_paths}, "function_floyd_warshall_MINI.o", "./function_floyd_warshall_MINI_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_floyd_warshall_MINI_explored_schedules.json", true);
	}else{
