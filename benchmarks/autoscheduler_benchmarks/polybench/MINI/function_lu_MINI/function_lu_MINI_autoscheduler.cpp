...
{
    tiramisu::init("function_lu_MINI");
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A}, "function_lu_MINI.o", "./function_lu_MINI_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_lu_MINI_explored_schedules.json", true);
	}else{
