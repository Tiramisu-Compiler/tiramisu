...
int main(int argc, char **argv)
 {
    ...
    var j_reversed("j_reversed", -64+1, 1), i_reversed("i_reversed", -64+1, 1);
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer b_imgIn("b_imgIn", {64,64}, p_float32, a_input);    
    buffer b_imgOut("b_imgOut", {64,64}, p_float32, a_output);    
    buffer b_y1("b_y1", {64,64}, p_float32, a_temporary);    
    buffer b_y2("b_y2", {64,64}, p_float32, a_temporary);  
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_imgIn, &b_imgOut}, "function_deriche_MINI.o", "./function_deriche_MINI_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_deriche_MINI_explored_schedules.json", true);
	}else{
