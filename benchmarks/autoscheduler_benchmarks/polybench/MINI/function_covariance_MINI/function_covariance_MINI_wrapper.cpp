...
int main(int, char **argv)
{
	...
	double *b_cov = (double*)malloc(28*28* sizeof(double));
	parallel_init_buffer(b_cov, 28*28, (double)36);
	Halide::Buffer<double> buf02(b_cov, 28, 28);
	...
	{  
		...
		function_covariance_MINI(buf01.raw_buffer(),buf02.raw_buffer());
