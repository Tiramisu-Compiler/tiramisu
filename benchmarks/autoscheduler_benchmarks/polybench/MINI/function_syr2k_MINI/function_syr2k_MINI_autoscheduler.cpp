...
{
    tiramisu::init("function_syr2k_MINI");
...
//     var i("i", 0, 30), j("j", 0, 30), k("k", 0, 20);
    ...
    buffer b_B("b_B", {30,20}, p_float64, a_input);
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A, &b_B, &b_C}, "function_syr2k_MINI.o", "./function_syr2k_MINI_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_syr2k_MINI_explored_schedules.json", true);
	}else{
