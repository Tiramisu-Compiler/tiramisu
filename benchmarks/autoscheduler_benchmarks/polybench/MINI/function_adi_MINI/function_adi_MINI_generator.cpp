...
int main(int argc, char **argv)
{
    ...
    //Iteration variables    
    var i("i", 1, 20-1), j("j", 1, 20-1), t("t", 1, 20+1), j_reversed("j_reversed", -20+2, 0);
    var i_f("i_f", 0, 20), j_f("j_f", 0, 20);
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer b_u("b_u", {20,20}, p_float64, a_output);    
    buffer b_p("b_p", {20,20}, p_float64, a_temporary);    
    buffer b_q("b_q", {20,20}, p_float64, a_temporary);    
    buffer b_v("b_v", {20,20}, p_float64, a_temporary);    
    ...
    v_col_last.store_in(&b_v, {20-1,i});
    ...
    u_row_last.store_in(&b_u,{i,20-1});
