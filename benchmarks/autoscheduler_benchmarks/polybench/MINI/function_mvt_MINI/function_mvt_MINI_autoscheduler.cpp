...
int main(int argc, char **argv)
 {
  ...
  prepare_schedules_for_legality_checks();
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A, &b_y1, &b_y2, &b_x1, &b_x2}, "function_mvt_MINI.o", "./function_mvt_MINI_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_mvt_MINI_explored_schedules.json", true);
	}else{
