...

{
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_ex, &b_ey, &b_hz, &b_fict}, "function_fdtd_2d_MINI.o", "./function_fdtd_2d_MINI_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_fdtd_2d_MINI_explored_schedules.json", true);
	}else{
