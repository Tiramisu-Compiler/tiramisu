...
int main(int argc, char **argv)
 {
    ...
    tiramisu::init("function_deriche_SMALL");


    // -------------------------------------------------------
    // Layer I
    // ------------------------------------------------------- 
    constant HH("HH", 128), WW("WW",192);


    //Iteration variables    
    var i("i", 0, 192), j("j", 0, 128);
    var j_reversed("j_reversed", -128+1, 1), i_reversed("i_reversed", -192+1, 1);
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer b_imgIn("b_imgIn", {192,128}, p_float32, a_input);    
    buffer b_imgOut("b_imgOut", {192,128}, p_float32, a_output);    
    buffer b_y1("b_y1", {192,128}, p_float32, a_temporary);    
    buffer b_y2("b_y2", {192,128}, p_float32, a_temporary);  
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_imgIn, &b_imgOut}, "function_deriche_SMALL.o", "./function_deriche_SMALL_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_deriche_SMALL_explored_schedules.json", true);
	}else{
