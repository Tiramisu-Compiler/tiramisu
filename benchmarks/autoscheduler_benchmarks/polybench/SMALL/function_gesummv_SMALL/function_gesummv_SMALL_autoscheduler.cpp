...

{
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A, &b_B, &b_x, &b_y}, "function_gesummv_SMALL.o", "./function_gesummv_SMALL_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_gesummv_SMALL_explored_schedules.json", true);
	}else{
