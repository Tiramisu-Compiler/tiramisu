...
{
    tiramisu::init("function_syrk_SMALL");
...
//     var i("i", 0, 80), j("j", 0, 80), k("k", 0, 60);
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A, &b_C}, "function_syrk_SMALL.o", "./function_syrk_SMALL_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_syrk_SMALL_explored_schedules.json", true);
	}else{
