...

{
    ...
    // -------------------------------------------------------     
    //Iteration variables    
    var i_f("i_f", 0, 20), j_f("j_f", 0, 20), k_f("k_f", 0, 20);
    var t("t", 1, 40+1), i("i", 1, 20-1), j("j", 1, 20-1), k("k", 1, 20-1);
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer b_A("b_A", {20,20,20}, p_float64, a_output);    
    buffer b_B("b_B", {20,20,20}, p_float64, a_output);    
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A,&b_B}, "function_heat3d_SMALL.o", "./function_heat3d_SMALL_wrapper");
