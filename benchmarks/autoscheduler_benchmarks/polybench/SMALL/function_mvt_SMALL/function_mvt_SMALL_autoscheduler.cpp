...
int main(int argc, char **argv)
 {
  ...
  buffer b_y1("b_y1", {120}, p_float64, a_input);
  buffer b_y2("b_y2", {120}, p_float64, a_input);
  buffer b_x1("b_x1", {120}, p_float64, a_output);
  buffer b_x2("b_x2", {120}, p_float64, a_output);
  ...
  prepare_schedules_for_legality_checks();
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A, &b_y1, &b_y2, &b_x1, &b_x2}, "function_mvt_SMALL.o", "./function_mvt_SMALL_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_mvt_SMALL_explored_schedules.json", true);
	}else{
