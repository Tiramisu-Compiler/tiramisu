...
int main(int, char **argv)
{
	...
	double *b_C = (double*)malloc(120* sizeof(double));
	parallel_init_buffer(b_C, 120, (double)36);
	Halide::Buffer<double> buf02(b_C, 120);

	double *b_D = (double*)malloc(120*sizeof(double));
	parallel_init_buffer(b_D, 120, (double)19);
	Halide::Buffer<double> buf03(b_D, 120);
	...
	{  
		...
		function_mvt_SMALL(buf01.raw_buffer(), buf02.raw_buffer(), buf03.raw_buffer(), buf04.raw_buffer(), buf05.raw_buffer());
