...

{
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer b_paths("b_paths", {180,180}, p_float64, a_output);    
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_paths}, "function_floyd_warshall_SMALL.o", "./function_floyd_warshall_SMALL_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_floyd_warshall_SMALL_explored_schedules.json", true);
	}else{
