...
int main(int, char **argv)
{
	...
	double *b_cov = (double*)malloc(80*80* sizeof(double));
	parallel_init_buffer(b_cov, 80*80, (double)36);
	Halide::Buffer<double> buf02(b_cov, 80, 80);
	...
	{  
		...
		function_covariance_SMALL(buf01.raw_buffer(),buf02.raw_buffer());
