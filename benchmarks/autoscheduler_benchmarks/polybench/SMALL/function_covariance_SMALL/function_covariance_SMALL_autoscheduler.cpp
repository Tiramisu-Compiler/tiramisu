...

{
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_data, &b_cov}, "function_covariance_SMALL.o", "./function_covariance_SMALL_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_covariance_SMALL_explored_schedules.json", true);
	}else{
