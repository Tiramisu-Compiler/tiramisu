...
//     var i("i", 0, 80), j("j", 0, 80), k("k", 0, 60);
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A, &b_B, &b_C}, "function_syr2k_SMALL.o", "./function_syr2k_SMALL_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_syr2k_SMALL_explored_schedules.json", true);
	}else{
