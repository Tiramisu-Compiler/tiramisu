...
int main(int, char **argv)
{
	...
	double *b_D = (double*)malloc(1200*1200*sizeof(double));
	parallel_init_buffer(b_D, 1200*1200, (double)19);
	Halide::Buffer<double> buf03(b_D, 1200, 1200);
	...
	{  
		...
		function_gramschmidt_LARGE(buf01.raw_buffer(), buf02.raw_buffer(), buf03.raw_buffer());
