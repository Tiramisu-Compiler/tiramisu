...
int main(int, char **argv)
{
	...
	double *b_D = (double*)malloc(80*80*sizeof(double));
	parallel_init_buffer(b_D, 80*80, (double)19);
	Halide::Buffer<double> buf03(b_D, 80, 80);
	...
	double *b_B = (double*)malloc(2000*sizeof(double));
	parallel_init_buffer(b_B, 2000, (double)19);
	Halide::Buffer<double> buf06(b_B, 2000);
	...
	{  
		...
		function_trisolv_LARGE(buf01.raw_buffer(), buf04.raw_buffer(), buf05.raw_buffer());
