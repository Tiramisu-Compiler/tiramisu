...
int main(int argc, char **argv)
 {
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer b_imgIn("b_imgIn", {4096,2160}, p_float64, a_input);    
    buffer b_imgOut("b_imgOut", {4096,2160}, p_float64, a_output);    
    buffer b_y1("b_y1", {4096,2160}, p_float64, a_temporary);    
    buffer b_y2("b_y2", {4096,2160}, p_float64, a_temporary);  
