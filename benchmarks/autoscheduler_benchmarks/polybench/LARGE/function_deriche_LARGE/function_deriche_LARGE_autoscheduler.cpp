...
int main(int argc, char **argv)
 {
    ...
    tiramisu::init("function_deriche_LARGE");


    // -------------------------------------------------------
    // Layer I
    // ------------------------------------------------------- 
    constant HH("HH", 2160), WW("WW",4096);


    //Iteration variables    
    var i("i", 0, 4096), j("j", 0, 2160);
    var j_reversed("j_reversed", -2160+1, 1), i_reversed("i_reversed", -4096+1, 1);
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer b_imgIn("b_imgIn", {4096,2160}, p_float32, a_input);    
    buffer b_imgOut("b_imgOut", {4096,2160}, p_float32, a_output);    
    buffer b_y1("b_y1", {4096,2160}, p_float32, a_temporary);    
    buffer b_y2("b_y2", {4096,2160}, p_float32, a_temporary);  
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_imgIn, &b_imgOut}, "function_deriche_LARGE.o", "./function_deriche_LARGE_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_deriche_LARGE_explored_schedules.json", true);
	}else{
