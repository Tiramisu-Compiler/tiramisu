...
int main(int, char **argv)
{
	...
	double *b_cov = (double*)malloc(1200*1200* sizeof(double));
	parallel_init_buffer(b_cov, 1200*1200, (double)36);
	Halide::Buffer<double> buf02(b_cov, 1200, 1200);
	...
	{  
		...
		function_covariance_LARGE(buf01.raw_buffer(),buf02.raw_buffer());
