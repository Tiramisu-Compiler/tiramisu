...
{
    tiramisu::init("function_fdtd_2d_LARGE");
    ...
    //Iteration variables    
    var i_f("i_f", 0, 1000), j_f("j_f", 0, 1200), i_m("i_m", 0, 1000-1), j_m("j_m", 0, 1200-1);
    var t("t", 0, 500), i("i", 1, 1000), j("j", 1, 1200);
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer b_fict("b_fict", {500}, p_float64, a_input);    
    buffer b_ey("b_ey", {1000,1200}, p_float64, a_output);    
    buffer b_ex("b_ex", {1000,1200}, p_float64, a_output);    
    buffer b_hz("b_hz", {1000,1200}, p_float64, a_output);    
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_ex, &b_ey, &b_hz, &b_fict}, "function_fdtd_2d_LARGE.o", "./function_fdtd_2d_LARGE_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_fdtd_2d_LARGE_explored_schedules.json", true);
	}else{
