...
int main(int, char **argv)
{
	...
	double *b_B = (double*)malloc(1200*1000* sizeof(double));
	parallel_init_buffer(b_B, 1200*1000, (double)36);
	Halide::Buffer<double> buf02(b_B, 1200, 1000);

	double *b_C = (double*)malloc(1200*1200* sizeof(double));
	parallel_init_buffer(b_C , 1200*1200, (double)36);
	Halide::Buffer<double> buf03(b_C , 1200*1200);
	...
	{  
		...
		function_syr2k_LARGE(buf01.raw_buffer(), buf02.raw_buffer(), buf03.raw_buffer());
