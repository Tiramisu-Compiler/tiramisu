...
{
    tiramisu::init("function_fdtd_2d_MEDIUM");
    ...
    //Iteration variables    
    var i_f("i_f", 0, 200), j_f("j_f", 0, 240), i_m("i_m", 0, 200-1), j_m("j_m", 0, 240-1);
    var t("t", 0, 100), i("i", 1, 200), j("j", 1, 240);
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer b_fict("b_fict", {100}, p_float64, a_input);    
    buffer b_ey("b_ey", {200,240}, p_float64, a_output);    
    buffer b_ex("b_ex", {200,240}, p_float64, a_output);    
    buffer b_hz("b_hz", {200,240}, p_float64, a_output);    
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_ex, &b_ey, &b_hz, &b_fict}, "function_fdtd_2d_MEDIUM.o", "./function_fdtd_2d_MEDIUM_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_fdtd_2d_MEDIUM_explored_schedules.json", true);
	}else{
