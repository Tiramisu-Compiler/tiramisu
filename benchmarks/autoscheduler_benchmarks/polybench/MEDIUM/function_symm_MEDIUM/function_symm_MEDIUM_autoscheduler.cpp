...

{
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A, &b_B, &b_C}, "function_symm_MEDIUM.o", "./function_symm_MEDIUM_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_symm_MEDIUM_explored_schedules.json", true);
	}else{
