...
int main(int, char **argv)
{
	...
	double *b_D = (double*)malloc(240*240*sizeof(double));
	parallel_init_buffer(b_D, 240*240, (double)19);
	Halide::Buffer<double> buf03(b_D, 240, 240);
	...
	{  
		...
		function_gramschmidt_MEDIUM(buf01.raw_buffer(), buf02.raw_buffer(), buf03.raw_buffer());
