...
int main(int argc, char **argv)
 {
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer b_imgIn("b_imgIn", {720,480}, p_float64, a_input);    
    buffer b_imgOut("b_imgOut", {720,480}, p_float64, a_output);    
    buffer b_y1("b_y1", {720,480}, p_float64, a_temporary);    
    buffer b_y2("b_y2", {720,480}, p_float64, a_temporary);  
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_imgIn, &b_imgOut}, "function_deriche_MEDIUM.o", "./function_deriche_MEDIUM_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_deriche_MEDIUM_explored_schedules.json", true);
	}else{
