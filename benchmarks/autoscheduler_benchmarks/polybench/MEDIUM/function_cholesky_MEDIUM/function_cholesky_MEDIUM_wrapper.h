#ifndef HALIDE__generated_function_cholesky_no_schedule_h
#define HALIDE__generated_function_cholesky_no_schedule_h
...
extern "C" {
#endif
int function_cholesky_MEDIUM(halide_buffer_t *buf01);
#ifdef __cplusplus
}  // extern "C"
#endif
