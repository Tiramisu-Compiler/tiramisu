...

{
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer b_A("b_A", {400}, p_float64, a_output);    
    buffer b_B("b_B", {400}, p_float64, a_output);
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A,&b_B}, "function_jacobi1d_MEDIUM.o", "./function_jacobi1d_MEDIUM_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_jacobi1d_MEDIUM_explored_schedules.json", true);
	}else{
