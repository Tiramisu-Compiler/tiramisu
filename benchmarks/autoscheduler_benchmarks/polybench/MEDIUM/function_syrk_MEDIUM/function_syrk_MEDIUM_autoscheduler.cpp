...
{
    tiramisu::init("function_syrk_MEDIUM");
...
//     var i("i", 0, 240), j("j", 0, 240), k("k", 0, 200);
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A, &b_C}, "function_syrk_MEDIUM.o", "./function_syrk_MEDIUM_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_syrk_MEDIUM_explored_schedules.json", true);
	}else{
