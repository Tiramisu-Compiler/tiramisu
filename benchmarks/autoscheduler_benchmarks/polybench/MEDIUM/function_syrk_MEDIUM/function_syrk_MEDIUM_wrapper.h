#ifndef HALIDE__generated_function_syrk_no_schedule_h
#define HALIDE__generated_function_syrk_no_schedule_h
...
extern "C" {
#endif
int function_syrk_MEDIUM(halide_buffer_t *buf01, halide_buffer_t *buf02);
#ifdef __cplusplus
}  // extern "C"
#endif
