...

{
    ...
    // Layer I
    // ------------------------------------------------------- 
     var i("i", 0, 180), j("j", 0, 220), k("k", 0, 210), l("l", 0, 190);
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer b_A("b_A", {180,210}, p_float64, a_input);
    buffer b_B("b_B", {210,190}, p_float64, a_input);
    buffer b_C("b_C", {190,220}, p_float64, a_input);
    buffer b_D("b_D", {180,220}, p_float64, a_output);
    buffer b_tmp("b_tmp", {180,190}, p_float64, a_temporary);
