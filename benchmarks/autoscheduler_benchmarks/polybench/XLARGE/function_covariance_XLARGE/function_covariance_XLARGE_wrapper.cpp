...
int main(int, char **argv)
{
	...
	double *b_cov = (double*)malloc(2600*2600* sizeof(double));
	parallel_init_buffer(b_cov, 2600*2600, (double)36);
	Halide::Buffer<double> buf02(b_cov, 2600, 2600);
	...
	{  
		...
		function_covariance_XLARGE(buf01.raw_buffer(),buf02.raw_buffer());
