...
int main(int, char **argv)
{
	...
	double *b_B = (double*)malloc(2000*2600* sizeof(double));
	parallel_init_buffer(b_B, 2000*2600, (double)36);
	Halide::Buffer<double> buf02(b_B, 2000,2600);

	double *b_C = (double*)malloc(2000*2600* sizeof(double));
	parallel_init_buffer(b_C , 2000*2600, (double)36);
	Halide::Buffer<double> buf03(b_C , 2000, 2600);
	...
	{  
		...
		function_symm_XLARGE(buf01.raw_buffer(), buf02.raw_buffer(), buf03.raw_buffer());
