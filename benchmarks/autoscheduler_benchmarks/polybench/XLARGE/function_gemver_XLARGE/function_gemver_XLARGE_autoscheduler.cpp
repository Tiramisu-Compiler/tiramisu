...

{
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A, &b_u1, &b_u2, &b_v1, &b_v2, &b_y, &b_z, &b_A_hat, &b_x, &b_w}, "function_gemver_XLARGE.o", "./function_gemver_XLARGE_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_gemver_XLARGE_explored_schedules.json", true);
	}else{
