...
{
    tiramisu::init("function_syr2k_XLARGE");
...
//     var i("i", 0, 2600), j("j", 0, 2600), k("k", 0, 2000);
    ...
    buffer b_B("b_B", {2600,2000}, p_float64, a_input);
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A, &b_B, &b_C}, "function_syr2k_XLARGE.o", "./function_syr2k_XLARGE_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_syr2k_XLARGE_explored_schedules.json", true);
	}else{
