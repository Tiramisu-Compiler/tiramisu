...

{
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A,&b_B}, "function_heat3d_XLARGE.o", "./function_heat3d_XLARGE_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_heat3d_XLARGE_explored_schedules.json", true);
	}else{
