...
int main(int, char **argv)
{
	...
	double *b_C = (double*)malloc(4000* sizeof(double));
	parallel_init_buffer(b_C, 4000, (double)36);
	Halide::Buffer<double> buf02(b_C, 4000);

	double *b_D = (double*)malloc(4000*sizeof(double));
	parallel_init_buffer(b_D, 4000, (double)19);
	Halide::Buffer<double> buf03(b_D, 4000);
	...
	{  
		...
		function_mvt_XLARGE(buf01.raw_buffer(), buf02.raw_buffer(), buf03.raw_buffer(), buf04.raw_buffer(), buf05.raw_buffer());
