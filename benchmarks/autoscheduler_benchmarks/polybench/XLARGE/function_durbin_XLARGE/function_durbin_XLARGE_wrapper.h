#ifndef HALIDE__generated_function_durbin_no_schedule_h
#define HALIDE__generated_function_durbin_no_schedule_h
...
extern "C" {
#endif
int function_durbin_XLARGE(halide_buffer_t *buf01, halide_buffer_t *buf02);
#ifdef __cplusplus
}  // extern "C"
#endif
