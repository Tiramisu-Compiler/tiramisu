...
int main(int, char **)
{
  ...
  int8_t* w_in = (int8_t*) malloc(nlayers*4*hsize*(isize+hsize)*sizeof(int8_t));
  ...
  Halide::Buffer<int8_t> b_W(w_in, NUM_LAYERS, hsize/osize, 4, osize, isize + hsize);
