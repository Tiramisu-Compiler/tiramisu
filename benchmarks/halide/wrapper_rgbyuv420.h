...
int rgbyuv420_tiramisu(buffer_t *_b_input_buffer, buffer_t *_b_output_y_buffer, buffer_t *_b_output_u_buffer, buffer_t *_b_output_v_buffer) HALIDE_FUNCTION_ATTRS;
int rgbyuv420_tiramisu_argv(void **args) HALIDE_FUNCTION_ATTRS;
...
const struct halide_filter_metadata_t *rgbyuv420_tiramisu_metadata() HALIDE_FUNCTION_ATTRS;
