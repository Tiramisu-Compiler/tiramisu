...
int main(int argc, char* argv[]) {
    ...
    RGB2Gray.compile_to_object("build/generated_fct_cvtcolorautodist_ref.o", {in}, "cvtcolorautodist_ref");

    RGB2Gray.compile_to_lowered_stmt("build/generated_fct_cvtcolorautodist_ref.txt", {in}, Text);
