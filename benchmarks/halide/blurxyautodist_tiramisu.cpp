...
int main(int argc, char **argv) {
    ...
    function blurxy("blurxyautodist_tiramisu");
    ...
    c_input.split(i, _ROWS/NODES, i0, i1);
    c_blurx.split(i, _ROWS/NODES, i0, i1);
    c_blury.split(i, _ROWS/NODES, i0, i1);
    ...
    buffer b_input("b_input", {tiramisu::expr(_ROWS/NODES) , tiramisu::expr(_COLS) + 2}, p_uint32, a_input, &blurxy);
    buffer b_blurx("b_blurx", {tiramisu::expr(_ROWS/NODES), tiramisu::expr(_COLS) + 2}, p_uint32, a_temporary, &blurxy);
    buffer b_blury("b_blury", {tiramisu::expr(_ROWS/NODES), tiramisu::expr(_COLS)}, p_uint32, a_output, &blurxy);
    ...
    blurxy.codegen({&b_input, &b_blury}, "build/generated_fct_blurxyautodist.o");
}
