...
int main(int argc, char **argv)
{
    ...
    tiramisu::computation RGB2Gray_s0("[RGB2Gray_s0_v4_loop_min, RGB2Gray_s0_v4_loop_extent, RGB2Gray_s0_v3_loop_min, RGB2Gray_s0_v3_loop_extent]->{RGB2Gray_s0[RGB2Gray_s0_v4, RGB2Gray_s0_v3]: "
                        ...
                        tiramisu::expr(tiramisu::o_cast, tiramisu::p_uint8, (((((tiramisu::expr(tiramisu::o_cast, tiramisu::p_uint32, input(tiramisu::expr((int32_t)2), tiramisu::idx("RGB2Gray_s0_v4"), tiramisu::idx("RGB2Gray_s0_v3")))*tiramisu::expr((uint32_t)1868)) + (tiramisu::expr(tiramisu::o_cast, tiramisu::p_uint32, input(tiramisu::expr((int32_t)1), tiramisu::idx("RGB2Gray_s0_v4"), tiramisu::idx("RGB2Gray_s0_v3")))*tiramisu::expr((uint32_t)9617))) + (tiramisu::expr(tiramisu::o_cast, tiramisu::p_uint32, input(tiramisu::expr((int32_t)0), tiramisu::idx("RGB2Gray_s0_v4"), tiramisu::idx("RGB2Gray_s0_v3")))*tiramisu::expr((uint32_t)4899))) + (tiramisu::expr((uint32_t)1) << (tiramisu::expr((uint32_t)14) - tiramisu::expr((uint32_t)1)))) >> tiramisu::expr((uint32_t)14))), true, tiramisu::p_uint8, &cvtcolor_tiramisu);
