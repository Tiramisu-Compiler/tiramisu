...
int main(int argc, char **argv)
{
    ...
    coli::function filter2D_nordom_coli("filter2D_nordom_coli");
    coli::buffer buff_filter2D_nordom("buff_filter2D_nordom", 2, {coli::expr(1024), coli::expr(1024)}, coli::p_float32, NULL, coli::a_output, &filter2D_nordom_coli);
    coli::buffer buff_b0("buff_b0", 2, {coli::expr(1024), coli::expr(1024)}, coli::p_float32, NULL, coli::a_input, &filter2D_nordom_coli);
    coli::computation b0("{b0[i0, i1]: (0 <= i0 <= 1023) and (0 <= i1 <= 1023)}", expr(), false, coli::p_float32, &filter2D_nordom_coli);
    b0.set_access("{b0[i0, i1]->buff_b0[i0, i1]}");


    // Define loop bounds for dimension "filter2D_nordom_s0_y".
    coli::constant filter2D_nordom_s0_y_loop_min("filter2D_nordom_s0_y_loop_min", coli::expr((int32_t)0), coli::p_int32, true, NULL, 0, &filter2D_nordom_coli);
    coli::constant filter2D_nordom_s0_y_loop_extent("filter2D_nordom_s0_y_loop_extent", coli::expr((int32_t)1024), coli::p_int32, true, NULL, 0, &filter2D_nordom_coli);

    // Define loop bounds for dimension "filter2D_nordom_s0_x".
    coli::constant filter2D_nordom_s0_x_loop_min("filter2D_nordom_s0_x_loop_min", coli::expr((int32_t)0), coli::p_int32, true, NULL, 0, &filter2D_nordom_coli);
    coli::constant filter2D_nordom_s0_x_loop_extent("filter2D_nordom_s0_x_loop_extent", coli::expr((int32_t)1024), coli::p_int32, true, NULL, 0, &filter2D_nordom_coli);
    ...
    filter2D_nordom_coli.set_arguments({&buff_b0, &buff_filter2D_nordom});
    filter2D_nordom_coli.gen_time_processor_domain();
    filter2D_nordom_coli.gen_isl_ast();
    filter2D_nordom_coli.gen_halide_stmt();
    filter2D_nordom_coli.dump_halide_stmt();
    filter2D_nordom_coli.gen_halide_obj("build/generated_filter2D_nordom_coli_test.o");
