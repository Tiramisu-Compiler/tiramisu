...
int main(int argc, char **argv)
{
    ...
    // Add schedules.
    resampled_s0.split(resampled_s0_x, 8, resampled_s0_x_x, resampled_s0_x_v8);
    resampled_s0.tag_vector_level(resampled_s0_x_v8, 8);
