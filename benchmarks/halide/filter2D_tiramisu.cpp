...
int main(int argc, char **argv)
{
    ...
    tiramisu::buffer buff_filter2D("buff_filter2D", {tiramisu::expr(filter2D_extent_2), tiramisu::expr(filter2D_extent_1), tiramisu::expr(filter2D_extent_0)}, tiramisu::p_uint8, tiramisu::a_output, &filter2D_tiramisu);

    // Input buffers.
    int input_extent_2 = SIZE2;
    int input_extent_1 = SIZE1;
    int input_extent_0 = SIZE0;
    tiramisu::buffer buff_input("buff_input", {tiramisu::expr(input_extent_2), tiramisu::expr(input_extent_1), tiramisu::expr(input_extent_0)}, tiramisu::p_uint8, tiramisu::a_input, &filter2D_tiramisu);
    ...
    tiramisu::buffer buff_kernel("buff_kernel", {tiramisu::expr(kernel_extent_1), tiramisu::expr(kernel_extent_0)}, tiramisu::p_float32, tiramisu::a_input, &filter2D_tiramisu);
