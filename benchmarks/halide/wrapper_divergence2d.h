...
int divergence2d_coli(buffer_t *_b_input_buffer, buffer_t *_b_blury_buffer) HALIDE_FUNCTION_ATTRS;
int divergence2d_coli_argv(void **args) HALIDE_FUNCTION_ATTRS;
...
const struct halide_filter_metadata_t *divergence2d_coli_metadata() HALIDE_FUNCTION_ATTRS;
