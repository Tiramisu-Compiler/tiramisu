...
int main(int argc, char* argv[]) {
    ...
    affine.compile_to_object("build/generated_fct_warp_affinegpu_ref.o", {in}, "warp_affinegpu_ref", target);

    affine.compile_to_lowered_stmt("build/generated_fct_warp_affinegpu_ref.txt", {in}, HTML, target);
