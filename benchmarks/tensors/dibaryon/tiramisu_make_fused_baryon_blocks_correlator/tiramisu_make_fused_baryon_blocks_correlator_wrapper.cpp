     ...
     double* snk_psi_B1_im)
{
   ...
   printf("non-zero? %4.1f + I %4.1f ", b_C_r(0,2,0,0), b_C_i(0,2,0,0) );
...
int main(int, char **)
{
   ...
   for (int i = 0; i < nb_tests; i++)
   {
      ...
      make_nucleon_2pt(C_re, C_im, B1_prop_re, B1_prop_im, src_color_weights_r1, src_spin_weights_r1, src_weights_r1, src_color_weights_r2, src_spin_weights_r2, src_weights_r2, src_psi_B1_re, src_psi_B1_im, snk_psi_B1_re, snk_psi_B1_im, Nc, Ns, Vsrc, Vsnk, Lt, Nw, Nq, NsrcHex, NsnkHex, NsrcHex, NsnkHex, Nperms);
