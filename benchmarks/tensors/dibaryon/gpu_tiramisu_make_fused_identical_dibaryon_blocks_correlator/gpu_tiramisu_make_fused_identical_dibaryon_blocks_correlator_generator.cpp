...
void generate_function(std::string name)
{
    ...
    buffer buf_B1_prop_r_gpu("buf_B1_prop_r_gpu",   {Lt, Nc, Ns, Nc, Ns, Vsnk, Vsrc}, p_float64, a_temporary);
    buffer buf_B1_prop_i_gpu("buf_B1_prop_i_gpu",   {Lt, Nc, Ns, Nc, Ns, Vsnk, Vsrc}, p_float64, a_temporary);
    ...
    buffer buf_B1_prop_r_cpu("B1_prop_r",   {Lt, Nc, Ns, Nc, Ns, Vsnk, Vsrc}, p_float64, a_temporary);
    buffer buf_B1_prop_i_cpu("B1_prop_i",   {Lt, Nc, Ns, Nc, Ns, Vsnk, Vsrc}, p_float64, a_temporary);
