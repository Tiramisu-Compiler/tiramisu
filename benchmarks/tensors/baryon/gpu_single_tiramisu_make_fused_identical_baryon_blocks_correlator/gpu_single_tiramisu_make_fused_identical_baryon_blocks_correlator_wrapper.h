...
#define TEST_NAME_STR       "gpu_single_tiramisu_make_fused_identical_baryon_blocks_correaltor"
...
int gpu_single_tiramisu_make_fused_identical_baryon_blocks_correlator(
			    halide_buffer_t *,
			    halide_buffer_t *,
			    halide_buffer_t *,
			    halide_buffer_t *,
