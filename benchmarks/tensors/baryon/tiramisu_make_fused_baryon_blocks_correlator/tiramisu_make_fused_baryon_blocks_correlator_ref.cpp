            ...
            for (kCprime=0; kCprime<Nc_f; kCprime++) {
               for (kSprime=0; kSprime<Ns_f; kSprime++) {
                  for (x=0; x<Vsnk_f; x++) {
                     ...
                     std::complex<double> prop_0_p(prop_re[prop_index(0,t,kCprime,kSprime,iC,iS,y,x ,Nc_f,Ns_f,Vsrc_f,Vsnk_f,Nt_f)], prop_im[prop_index(0,t,kCprime,kSprime,iC,iS,y,x ,Nc_f,Ns_f,Vsrc_f,Vsnk_f,Nt_f)]);
                     ...
                     std::complex<double> prop_2_p(prop_re[prop_index(2,t,iCprime,iSprime,kC,kS,y,x ,Nc_f,Ns_f,Vsrc_f,Vsnk_f,Nt_f)], prop_im[prop_index(2,t,iCprime,iSprime,kC,kS,y,x ,Nc_f,Ns_f,Vsrc_f,Vsnk_f,Nt_f)]);
                     prop_prod_02 = weights[wnum] * ( prop_0 * prop_2 - prop_0_p * prop_2_p );
                     for (jCprime=0; jCprime<Nc_f; jCprime++) {
                        for (jSprime=0; jSprime<Ns_f; jSprime++) {
