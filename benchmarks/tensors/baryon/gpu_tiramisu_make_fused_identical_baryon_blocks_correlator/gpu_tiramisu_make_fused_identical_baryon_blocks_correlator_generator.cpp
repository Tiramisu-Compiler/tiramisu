...
void generate_function(std::string name)
{
   ...
   input out_C_r("out_C_r",      {t, rp, m, r, n}, p_float64);
   input out_C_i("out_C_i",      {t, rp, m, r, n}, p_float64);
   ...
   input sigs("sigs", {nperm}, p_int32);
    ...
    computation C_init_r_cpu("C_init_r_cpu", {t, x_out, x_in, rp, m, r, n}, expr((double) 0));
    computation C_init_i_cpu("C_init_i_cpu", {t, x_out, x_in, rp, m, r, n}, expr((double) 0));

    computation out_C_init_r_cpu("out_C_init_r_cpu", {t, rp, m, r, n}, expr((double) 0));
    computation out_C_init_i_cpu("out_C_init_i_cpu", {t, rp, m, r, n}, expr((double) 0));
    ...
    // declaring buffers
    buffer out_buf_C_r_cpu("out_buf_C_r_cpu", {Lt, B1Nrows, NsrcHex, B1Nrows, NsnkHex}, p_float64, a_temporary);
    buffer out_buf_C_i_cpu("out_buf_C_i_cpu", {Lt, B1Nrows, NsrcHex, B1Nrows, NsnkHex}, p_float64, a_temporary);

    buffer buf_C_r("buf_C_r", {Lt, Vsnk/sites_per_rank, sites_per_rank, B1Nrows, NsrcHex, B1Nrows, NsnkHex}, p_float64, a_temporary);
    buffer buf_C_i("buf_C_i", {Lt, Vsnk/sites_per_rank, sites_per_rank, B1Nrows, NsrcHex, B1Nrows, NsnkHex}, p_float64, a_temporary);
    buffer buf_C_r_cpu("buf_C_r_cpu", {Lt, Vsnk/sites_per_rank, sites_per_rank, B1Nrows, NsrcHex, B1Nrows, NsnkHex}, p_float64, a_temporary);
    buffer buf_C_i_cpu("buf_C_i_cpu", {Lt, Vsnk/sites_per_rank, sites_per_rank, B1Nrows, NsrcHex, B1Nrows, NsnkHex}, p_float64, a_temporary);
    ...
    computation reduce_buf_C_r_cpu("reduce_buf_C_r_cpu", {t, x_out, x_in, rp, m, r, n}, p_float64);
    reduce_buf_C_r_cpu.set_expression( reduce_buf_C_r_cpu( t, x_out, x_in, rp, m, r, n) + C_init_r_cpu( t, x_out, x_in, rp, m, r, n ) );
    computation reduce_buf_C_i_cpu("reduce_buf_C_i_cpu", {t, x_out, x_in, rp, m, r, n}, p_float64);
    ...
    buffer buf_B1_prop_r("buf_B1_prop_r",   {Lt, Nc, Ns, Nc, Ns, Vsnk, Vsrc}, p_float64, a_temporary);
    buffer buf_B1_prop_i("buf_B1_prop_i",   {Lt, Nc, Ns, Nc, Ns, Vsnk, Vsrc}, p_float64, a_temporary);
   ...
   buf_C_prop_i.tag_gpu_global();
    ...
    buffer B1_prop_r_cpu("B1_prop_r_cpu",   {Lt, Nc, Ns, Nc, Ns, Vsnk, Vsrc}, p_float64, a_temporary);
    buffer B1_prop_i_cpu("B1_prop_i_cpu",   {Lt, Nc, Ns, Nc, Ns, Vsnk, Vsrc}, p_float64, a_temporary);
