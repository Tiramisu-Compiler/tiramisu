...
class function:
    ...
    @overload
    def skewing_local_solver(self, fused_computations: List[computation], outer_variable: var, inner_variable: var, nb_parallel: int) -> Tuple[List[int], List[int], List[int]]: ...
    @overload
    def skewing_local_solver(self, fused_computations: List[computation], outer_variable: int, inner_variable: int, nb_parallel: int) -> Tuple[List[int], List[int], List[int]]: ...
