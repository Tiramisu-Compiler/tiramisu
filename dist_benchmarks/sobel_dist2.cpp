...
#include "wrapper_sobel_dist2.h" // has the sizes in it
...
int main(int argc, char **argv)
{
    ...
    tiramisu::function sobel_dist("sobel_dist2");
    ...
    sobel_dist.codegen({&buff_input, &buff_sobel}, "build/generated_fct_sobel_dist2.o");
